...
import { _ as _interopRequireDefault, c as require$$1, r as require$$3, d as _util, e as require$$0 } from './index-986f40ca.js';
import { a as lib$3 } from './index-08be7313.js';
...
var _slicedToArray2 = _interopRequireDefault(require$$1);
...
var _polylineToBezierCurve = _interopRequireDefault(polylineToBezierCurve_1);
...
var _bezierCurve2 = _interopRequireDefault(lib);
...
var _classCallCheck2 = _interopRequireDefault(classCallCheck);
...
Style.prototype.colorProcessor = function (style) {
  ...
  var processor = reverse ? lib$3.getColorFromRgbValue : lib$3.getRgbaValue;
...
function initGraphStyle(ctx, style) {
  ...
  ctx.fillStyle = (0, lib$3.getColorFromRgbValue)(fill);
  ctx.strokeStyle = (0, lib$3.getColorFromRgbValue)(stroke);
  ctx.shadowColor = (0, lib$3.getColorFromRgbValue)(shadowColor);
...
function initGradient(ctx, style) {
  ...
  gradientColor = gradientColor.map(function (c) {
    return (0, lib$3.getColorFromRgbValue)(c);
  });
...
var _curves = _interopRequireDefault(curves);
...
var _asyncToGenerator2 = _interopRequireDefault(asyncToGenerator);
...
var _transition = _interopRequireDefault(lib$1);
...
var _color = _interopRequireDefault(lib$3);

var _bezierCurve = _interopRequireDefault(lib);
...
export { CRender as C, lib$3 as _, defineProperty as a, lib as b, lib$2 as l, classCallCheck as r };
//# sourceMappingURL=index-4ffa622f.js.map
