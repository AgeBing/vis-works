...
var bezierCurveToPolyline_1 = styleInject_es.createCommonjsModule(function (module, exports) {
...
styleInject_es.unwrapExports(bezierCurveToPolyline_1);
...
var polylineToBezierCurve_1 = styleInject_es.createCommonjsModule(function (module, exports) {
...
styleInject_es.unwrapExports(polylineToBezierCurve_1);
...
var _polylineToBezierCurve = index$1$1._interopRequireDefault(polylineToBezierCurve_1);
...
var canvas = styleInject_es.createCommonjsModule(function (module, exports) {
...
styleInject_es.unwrapExports(canvas);
var canvas_1 = canvas.drawPolylinePath;
var canvas_2 = canvas.drawBezierCurvePath;

var graphs_1 = styleInject_es.createCommonjsModule(function (module, exports) {
...
var _bezierCurve2 = index$1$1._interopRequireDefault(lib);
...
var circle = {
  ...
  hoverCheck: function hoverCheck(position, _ref4) {
    ...
    var rx = shape.rx,
        ry = shape.ry,
        r = shape.r;
    return (0, index$1$1._util.checkPointIsInCircle)(position, rx, ry, r);
  },
...
var ellipse = {
  ...
  hoverCheck: function hoverCheck(position, _ref11) {
    ...
    var distance = (0, index$1$1._util.getTwoPointDistance)(position, leftFocusPoint) + (0, index$1$1._util.getTwoPointDistance)(position, rightFocusPoint);
    return distance <= 2 * a;
  },
...
var rect = {
  ...
  hoverCheck: function hoverCheck(position, _ref18) {
    ...
    var x = shape.x,
        ...
        w = shape.w,
        h = shape.h;
    return (0, index$1$1._util.checkPointIsInRect)(position, x, y, w, h);
  },
...
var ring = {
  ...
  hoverCheck: function hoverCheck(position, _ref25) {
    ...
    var distance = (0, index$1$1._util.getTwoPointDistance)(position, [rx, ry]);
...
var arc = {
  ...
  hoverCheck: function hoverCheck(position, _ref32) {
    ...
    return !(0, index$1$1._util.checkPointIsInSector)(position, rx, ry, insideRadius, startAngle, endAngle, clockWise) && (0, index$1$1._util.checkPointIsInSector)(position, rx, ry, outsideRadius, startAngle, endAngle, clockWise);
  },
...
var sector = {
  ...
  hoverCheck: function hoverCheck(position, _ref39) {
    ...
    var rx = shape.rx,
        ...
        endAngle = shape.endAngle,
        clockWise = shape.clockWise;
    return (0, index$1$1._util.checkPointIsInSector)(position, rx, ry, r, startAngle, endAngle, clockWise);
  },
...
var regPolygon = {
  ...
  draw: function draw(_ref44, _ref45) {
    ...
    if (!cache.points || cache.rx !== rx || cache.ry !== ry || cache.r !== r || cache.side !== side) {
      var _points = (0, index$1$1._util.getRegularPolygonPoints)(rx, ry, r, side);
  ...
  hoverCheck: function hoverCheck(position, _ref46) {
    ...
    var points = cache.points;
    return (0, index$1$1._util.checkPointIsInPolygon)(position, points);
  },
...
var polyline = {
  ...
  draw: function draw(_ref53, _ref54) {
    ...
    var points = shape.points,
        close = shape.close;
    if (lineWidth === 1) points = (0, index$1$1._util.eliminateBlur)(points);
    (0, canvas.drawPolylinePath)(ctx, points);
  ...
  hoverCheck: function hoverCheck(position, _ref55) {
    ...
    if (close) {
      ...
      return (0, index$1$1._util.checkPointIsNearPolyline)(position, points, lineWidth);
    }
  },
...
var smoothline = {
  ...
  draw: function draw(_ref62, _ref63) {
    ...
    if (!cache.points || cache.points.toString() !== points.toString()) {
      ...
      Object.assign(cache, {
        points: (0, index$1$1._util.deepClone)(points, true),
  ...
  hoverCheck: function hoverCheck(position, _ref64) {
    ...
    if (close) {
      return (0, index$1$1._util.checkPointIsInPolygon)(position, hoverPoints);
    } else {
      return (0, index$1$1._util.checkPointIsNearPolyline)(position, hoverPoints, lineWidth);
    }
  },
...
styleInject_es.unwrapExports(graphs_1);
...
var runtime_1 = styleInject_es.createCommonjsModule(function (module) {
/**
...
var style_class = styleInject_es.createCommonjsModule(function (module, exports) {
...
var _classCallCheck2 = index$1$1._interopRequireDefault(classCallCheck);
...
Style.prototype.colorProcessor = function (style) {
  ...
  var processor = reverse ? index$2.lib.getColorFromRgbValue : index$2.lib.getRgbaValue;
...
function initGraphStyle(ctx, style) {
  ...
  ctx.fillStyle = (0, index$2.lib.getColorFromRgbValue)(fill);
  ctx.strokeStyle = (0, index$2.lib.getColorFromRgbValue)(stroke);
  ctx.shadowColor = (0, index$2.lib.getColorFromRgbValue)(shadowColor);
...
function initGradient(ctx, style) {
  ...
  gradientColor = gradientColor.map(function (c) {
    return (0, index$2.lib.getColorFromRgbValue)(c);
  });
...
Style.prototype.getStyle = function () {
  var clonedStyle = (0, index$1$1._util.deepClone)(this, true);
  this.colorProcessor(clonedStyle, true);
  return clonedStyle;
};
});

styleInject_es.unwrapExports(style_class);

var curves = styleInject_es.createCommonjsModule(function (module, exports) {
...
styleInject_es.unwrapExports(curves);
...
var _curves = index$1$1._interopRequireDefault(curves);
...
var lib_1 = lib$1.transition;
var lib_2 = lib$1.injectNewCurve;

var graph_class = styleInject_es.createCommonjsModule(function (module, exports) {
...
var _regenerator = index$1$1._interopRequireDefault(regenerator);

var _asyncToGenerator2 = index$1$1._interopRequireDefault(asyncToGenerator);
...
var _style = index$1$1._interopRequireDefault(style_class);

var _transition = index$1$1._interopRequireDefault(lib$1);
...
var Graph = function Graph(graph, config) {
  ...
  config = (0, index$1$1._util.deepClone)(config, true);
  var defaultConfig = {
    /**
...
Graph.prototype.hoverCheckProcessor = function (position, _ref) {
  ...
  if (graphCenter) {
    if (rotate) position = (0, index$1$1._util.getRotatePointPos)(-rotate, position, graphCenter);
    if (scale) position = (0, index$1$1._util.getScalePointPos)(scale.map(function (s) {
      return 1 / s;
    }), position, graphCenter);
    if (translate) position = (0, index$1$1._util.getTranslatePointPos)(translate.map(function (v) {
      return v * -1;
    }), position);
  }

  if (hoverRect) return index$1$1._util.checkPointIsInRect.apply(void 0, [position].concat((0, _toConsumableArray2["default"])(hoverRect)));
...
Graph.prototype.attr = function (attrName) {
  ...
  if (isObject) change = (0, index$1$1._util.deepClone)(change, true);
    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            change = (0, index$1$1._util.deepClone)(change, true);
...
styleInject_es.unwrapExports(graph_class);

var crender_class = styleInject_es.createCommonjsModule(function (module, exports) {
...
var _defineProperty2 = index$1$1._interopRequireDefault(defineProperty);

var _toConsumableArray2 = index$1$1._interopRequireDefault(index$1$1.require$$3);

var _classCallCheck2 = index$1$1._interopRequireDefault(classCallCheck);

var _color = index$1$1._interopRequireDefault(index$2.lib);

var _bezierCurve = index$1$1._interopRequireDefault(lib);



var _graphs = index$1$1._interopRequireDefault(graphs_1);

var _graph = index$1$1._interopRequireDefault(graph_class);
...
CRender.prototype.clone = function (graph) {
  ...
  clonedGraph = (0, index$1$1._util.deepClone)(clonedGraph, true);
  return this.add(clonedGraph);
};
});

styleInject_es.unwrapExports(crender_class);

var lib$2 = styleInject_es.createCommonjsModule(function (module, exports) {
...
var _crender = index$1$1._interopRequireDefault(crender_class);
...
var CRender = styleInject_es.unwrapExports(lib$2);

exports.CRender = CRender;
exports._color = index$2.lib;
exports.lib = lib$2;
exports.require$$0 = defineProperty;
exports.require$$1 = classCallCheck;
exports.require$$4 = lib;
//# sourceMappingURL=index-c21ace42.js.map
