...
function mergeOffset(_ref3, _ref4) {
  var _ref6 = _babelHelpers.slicedToArray(_ref3, 2),
      x = _ref6[0],
      y = _ref6[1];

  var _ref5 = _babelHelpers.slicedToArray(_ref4, 2),
      ox = _ref5[0],
      oy = _ref5[1];
...
var WaterLevelPond = function WaterLevelPond(_ref13) {
  ...
  var mergedConfig = React.useMemo(function () {
    return index$1$1.util_2(index$1$1.util_1(defaultConfig, true), config);
  }, [config]);
  ...
  var classNames = React.useMemo(function () {
    return index$1.classnames('dv-water-pond-level', className);
  }, [className]);
