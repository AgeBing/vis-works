...
function calcAligns(mergedConfig, header) {
  ...
  return index$1$1.util_2(aligns, align);
}
...
var ScrollBoard = function ScrollBoard(_ref3) {
  ...
  function calcWidths(_ref4, rowsData) {
    ...
    return index$1$1.util_2(widths, columnWidth);
  }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            rows.push.apply(rows, _babelHelpers.toConsumableArray(rowsData.slice(0, animationIndex)));
