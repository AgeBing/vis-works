...
var index$4 = require('./index-b652a004.js');
...
var grid = styleInject_es.createCommonjsModule(function (module, exports) {
...
styleInject_es.unwrapExports(grid);
var grid_1 = grid.gridConfig;

var axis = styleInject_es.createCommonjsModule(function (module, exports) {
...
styleInject_es.unwrapExports(axis);
var axis_1 = axis.yAxisConfig;
var axis_2 = axis.xAxisConfig;

var title = styleInject_es.createCommonjsModule(function (module, exports) {
...
styleInject_es.unwrapExports(title);
var title_1 = title.titleConfig;

var line = styleInject_es.createCommonjsModule(function (module, exports) {
...
styleInject_es.unwrapExports(line);
var line_1 = line.lineConfig;

var bar = styleInject_es.createCommonjsModule(function (module, exports) {
...
styleInject_es.unwrapExports(bar);
var bar_1 = bar.barConfig;

var pie = styleInject_es.createCommonjsModule(function (module, exports) {
...
styleInject_es.unwrapExports(pie);
var pie_1 = pie.pieConfig;

var radarAxis = styleInject_es.createCommonjsModule(function (module, exports) {
...
styleInject_es.unwrapExports(radarAxis);
var radarAxis_1 = radarAxis.radarAxisConfig;

var radar = styleInject_es.createCommonjsModule(function (module, exports) {
...
styleInject_es.unwrapExports(radar);
var radar_1 = radar.radarConfig;

var gauge = styleInject_es.createCommonjsModule(function (module, exports) {
...
styleInject_es.unwrapExports(gauge);
var gauge_1 = gauge.gaugeConfig;

var legend = styleInject_es.createCommonjsModule(function (module, exports) {
...
styleInject_es.unwrapExports(legend);
var legend_1 = legend.legendConfig;

var config = styleInject_es.createCommonjsModule(function (module, exports) {
...
function changeDefaultConfig(key, config) {
  ...
  (0, index$4._util2.deepMerge)(allConfig["".concat(key, "Config")], config);
}
...
styleInject_es.unwrapExports(config);
var config_1 = config.changeDefaultConfig;
var config_2 = config.keys;

var mergeColor_1 = styleInject_es.createCommonjsModule(function (module, exports) {
...
function mergeColor(chart) {
  ...
  var defaultColor = (0, index$1$1._util.deepClone)(config.colorConfig, true);
  var color = option.color,
      series = option.series;
  if (!series) series = [];
  if (!color) color = [];
  option.color = color = (0, index$4._util2.deepMerge)(defaultColor, color);
...
styleInject_es.unwrapExports(mergeColor_1);
var mergeColor_2 = mergeColor_1.mergeColor;

var updater_class = styleInject_es.createCommonjsModule(function (module, exports) {
...
var _toConsumableArray2 = index$1$1._interopRequireDefault(index$1$1.require$$3);

var _typeof2 = index$1$1._interopRequireDefault(index$1$1.require$$0);

var _classCallCheck2 = index$1$1._interopRequireDefault(index$3.require$$1);
...
styleInject_es.unwrapExports(updater_class);
var updater_class_1 = updater_class.doUpdate;
var updater_class_2 = updater_class.Updater;

var title_1$1 = styleInject_es.createCommonjsModule(function (module, exports) {
...
var _slicedToArray2 = index$1$1._interopRequireDefault(index$1$1.require$$1);
...
function title(chart) {
  ...
  if (option.title) {
    title[0] = (0, index$4._util2.deepMerge)((0, index$1$1._util.deepClone)(config.titleConfig, true), option.title);
  }
...
styleInject_es.unwrapExports(title_1$1);
var title_2 = title_1$1.title;

var grid_1$1 = styleInject_es.createCommonjsModule(function (module, exports) {
...
var _defineProperty2 = index$1$1._interopRequireDefault(index$3.require$$0);
...
function grid(chart) {
  ...
  grid = (0, index$4._util2.deepMerge)((0, index$1$1._util.deepClone)(config.gridConfig, true), grid || {});
  (0, updater_class.doUpdate)({
    chart: chart,
    series: [grid],
    key: 'grid',
...
styleInject_es.unwrapExports(grid_1$1);
var grid_2 = grid_1$1.grid;

var axis_1$1 = styleInject_es.createCommonjsModule(function (module, exports) {
...
function mergeDefaultAxisConfig(allAxis) {
  ...
  xAxis = xAxis.map(function (axis) {
    return (0, index$4._util2.deepMerge)((0, index$1$1._util.deepClone)(config.xAxisConfig), axis);
  });
  yAxis = yAxis.map(function (axis) {
    return (0, index$4._util2.deepMerge)((0, index$1$1._util.deepClone)(config.yAxisConfig), axis);
  });
...
function getSeriesMinMaxValue(series) {
  ...
  var minValue = Math.min.apply(Math, (0, _toConsumableArray2["default"])(series.map(function (_ref9) {
    var data = _ref9.data;
    return Math.min.apply(Math, (0, _toConsumableArray2["default"])((0, index$4._util2.filterNonNumber)(data)));
  })));
  var maxValue = Math.max.apply(Math, (0, _toConsumableArray2["default"])(series.map(function (_ref10) {
    var data = _ref10.data;
    return Math.max.apply(Math, (0, _toConsumableArray2["default"])((0, index$4._util2.filterNonNumber)(data)));
  })));
  return [minValue, maxValue];
}

function mergeStackData(series) {
  var seriesCloned = (0, index$1$1._util.deepClone)(series, true);
  series.forEach(function (item, i) {
    var data = (0, index$4._util2.mergeSameStackData)(item, series);
...
function getTickLinePosition(axisType, boundaryGap, position, tickPosition, gap) {
  ...
  var tickLinePosition = tickPosition.map(function (lineStart) {
    var lineEnd = (0, index$1$1._util.deepClone)(lineStart);
    lineEnd[index] += plus;
    return [(0, index$1$1._util.deepClone)(lineStart), lineEnd];
  });
...
function getLabelRealPosition(points, position) {
  ...
  points = (0, index$1$1._util.deepClone)(points);
  points[index] += plus;
  return points;
}
...
function getLabelStyle(axisItem, shapes) {
  ...
  style = (0, index$4._util2.deepMerge)(align, style);
...
function getNameStyle(axisItem) {
  ...
  return (0, index$4._util2.deepMerge)(align, style);
}
...
styleInject_es.unwrapExports(axis_1$1);
var axis_2$1 = axis_1$1.axis;

var line_1$1 = styleInject_es.createCommonjsModule(function (module, exports) {
...
var _bezierCurve = index$1$1._interopRequireDefault(index$3.require$$4);
...
function line(chart) {
  ...
  if (xAxis && yAxis && series) {
    lines = (0, index$4._util2.initNeedSeries)(series, config.lineConfig, 'line');
...
function calcLinesPosition(lines, chart) {
  ...
  return lines.map(function (lineItem) {
    var lineData = (0, index$4._util2.mergeSameStackData)(lineItem, lines);
...
function getLineLength(points) {
  ...
  if (!smooth) return (0, index$4._util2.getPolylineLength)(points);
...
styleInject_es.unwrapExports(line_1$1);
var line_2 = line_1$1.line;

var bar_1$1 = styleInject_es.createCommonjsModule(function (module, exports) {
...
function bar(chart) {
  ...
  if (xAxis && yAxis && series) {
    bars = (0, index$4._util2.initNeedSeries)(series, config.barConfig, 'bar');
...
function calcBarValueAxisCoordinate(bars) {
  return bars.map(function (bar) {
    var data = (0, index$4._util2.mergeSameStackData)(bar, bars);
...
function getBarStyle(barItem, i) {
  ...
  var gradientColor = (0, index$4._util2.deepMerge)(fillColor, gradient.color);
  if (gradientColor.length === 1) gradientColor.push(gradientColor[0]);
...
function getStartLeftEchelonShape(shape, barItem) {
  ...
  shape = (0, index$1$1._util.deepClone)(shape);
  var _shape = shape,
...
function getLabelStyle(barItem) {
  ...
  style = (0, index$4._util2.deepMerge)({
    fill: color
  }, style);
  return style;
}
...
styleInject_es.unwrapExports(bar_1$1);
var bar_2 = bar_1$1.bar;

var pie_1$1 = styleInject_es.createCommonjsModule(function (module, exports) {
...
function pie$1(chart) {
  ...
  if (!series) series = [];
  var pies = (0, index$4._util2.initNeedSeries)(series, pie.pieConfig, 'pie');
...
function calcPiesPercent(pies) {
  pies.forEach(function (pie) {
    ...
    var percentSumNoLast = (0, index$4._util2.mulAdd)(data.slice(0, -1).map(function (_ref5) {
...
function getDataSum(data) {
  return (0, index$4._util2.mulAdd)(data.map(function (_ref6) {
...
function getDataAngle(data, i) {
  ...
  var percentSum = (0, index$4._util2.mulAdd)(needAddData.map(function (_ref7) {
...
function getPieInsideLabelPos(pieItem, dataItem) {
  ...
  return index$1$1._util.getCircleRadianPoint.apply(void 0, (0, _toConsumableArray2["default"])(center).concat([radius, angle]));
}
...
function calcPiesEdgeCenterPos(pies) {
  pies.forEach(function (pie) {
    ...
    data.forEach(function (item) {
      ...
      var pos = index$1$1._util.getCircleRadianPoint.apply(void 0, (0, _toConsumableArray2["default"])(center).concat([radius[1], centerAngle]));
...
function addLabelLineAndAlign(dataItem, pieItem) {
  ...
  dataItem.forEach(function (item) {
    ...
    var bendPoint = index$1$1._util.getCircleRadianPoint.apply(void 0, (0, _toConsumableArray2["default"])(center).concat([radius, angle]));
    ...
    item.labelLineLength = (0, index$4._util2.getPolylineLength)(item.labelLine);
    item.align = {
      textAlign: 'left',
      textBaseline: 'middle'
    };
...
function getOutsideLabelStyle(pieItem, i) {
  ...
  return (0, index$4._util2.deepMerge)(_objectSpread({
    fill: color
  }, align), style);
}
});

styleInject_es.unwrapExports(pie_1$1);
var pie_2 = pie_1$1.pie;

var radarAxis_1$1 = styleInject_es.createCommonjsModule(function (module, exports) {
...
function mergeRadarAxisDefaultConfig(radar) {
  return (0, index$4._util2.deepMerge)((0, index$1$1._util.deepClone)(config.radarAxisConfig), radar);
}
...
function calcRadarAxisLinePosition(radarAxis) {
  ...
  radarAxis.axisLinePosition = angles.map(function (g) {
    return index$1$1._util.getCircleRadianPoint.apply(void 0, (0, _toConsumableArray2["default"])(centerPos).concat([radius, g]));
  });
  return radarAxis;
}
...
function calcRadarAxisLabelPosition(radarAxis) {
  ...
  radarAxis.axisLabelPosition = axisLineAngles.map(function (angle) {
    return index$1$1._util.getCircleRadianPoint.apply(void 0, (0, _toConsumableArray2["default"])(centerPos).concat([radius, angle]));
  });
  return radarAxis;
}
...
function getSplitAreaStyle(radarAxis, i) {
  ...
  if (polygon) {
    var point1 = index$1$1._util.getCircleRadianPoint.apply(void 0, (0, _toConsumableArray2["default"])(centerPos).concat([ringRadius[0], axisLineAngles[0]]));

    var point2 = index$1$1._util.getCircleRadianPoint.apply(void 0, (0, _toConsumableArray2["default"])(centerPos).concat([ringRadius[0], axisLineAngles[1]]));

    lineWidth = (0, index$4._util2.getPointToLineDistance)(centerPos, point1, point2);
  }

  style = (0, index$4._util2.deepMerge)((0, index$1$1._util.deepClone)(style, true), {
    lineWidth: lineWidth
  });
  if (!color.length) return style;
  var colorNum = color.length;
  return (0, index$4._util2.deepMerge)(style, {
...
styleInject_es.unwrapExports(radarAxis_1$1);
var radarAxis_2 = radarAxis_1$1.radarAxis;

var radar_1$1 = styleInject_es.createCommonjsModule(function (module, exports) {
...
function radar(chart) {
  ...
  var series = option.series;
  if (!series) series = [];
  var radars = (0, index$4._util2.initNeedSeries)(series, config.radarConfig, 'radar');
...
function calcRadarPosition(radars, chart) {
  ...
  radars.forEach(function (radarItem) {
    ...
    radarItem.radarPosition = indicator.map(function (_ref, i) {
      ...
      return index$1$1._util.getCircleRadianPoint.apply(void 0, (0, _toConsumableArray2["default"])(centerPos).concat([dataRadius, axisLineAngles[i]]));
    });
  });
  return radars;
}
...
function calcRadarLabelPosition(radars, chart) {
  ...
  radars.forEach(function (radarItem) {
    ...
    radarItem.labelPosition = dataRadius.map(function (r, i) {
      return index$1$1._util.getCircleRadianPoint.apply(void 0, (0, _toConsumableArray2["default"])(centerPos).concat([r + labelGap, axisLineAngles[i]]));
    });
  });
  return radars;
}
...
function getRadarStyle(radarItem) {
  ...
  var colorRgbaValue = (0, index$3._color.getRgbaValue)(color);
  colorRgbaValue[3] = 0.5;
  var radarDefaultColor = {
    stroke: color,
    fill: (0, index$3._color.getColorFromRgbValue)(colorRgbaValue)
  };
  return (0, index$4._util2.deepMerge)(radarDefaultColor, radarStyle);
}
...
function getLabelStyle(radarItem, i) {
  ...
  return (0, index$4._util2.deepMerge)(defaultColorAndAlign, style);
}
});

styleInject_es.unwrapExports(radar_1$1);
var radar_2 = radar_1$1.radar;

var gauge_1$1 = styleInject_es.createCommonjsModule(function (module, exports) {
...
function gauge$1(chart) {
  ...
  var series = option.series;
  if (!series) series = [];
  var gauges = (0, index$4._util2.initNeedSeries)(series, gauge.gaugeConfig, 'gauge');
...
function calcGaugesAxisTickPosition(gauges, chart) {
  gauges.forEach(function (gaugeItem) {
    ...
    gaugeItem.tickPosition = new Array(splitNum).fill(0).map(function (foo, i) {
      ...
      return [index$1$1._util.getCircleRadianPoint.apply(void 0, (0, _toConsumableArray2["default"])(center).concat([outerRadius, angle])), index$1$1._util.getCircleRadianPoint.apply(void 0, (0, _toConsumableArray2["default"])(center).concat([innerRadius, angle]))];
    });
  });
  return gauges;
}
...
function calcGaugesLabelPositionAndAlign(gauges, chart) {
  gauges.forEach(function (gaugeItem) {
    ...
    var position = tickAngles.map(function (angle, i) {
      return index$1$1._util.getCircleRadianPoint.apply(void 0, (0, _toConsumableArray2["default"])(center).concat([tickInnerRadius[i] - labelGap, tickAngles[i]]));
    });
...
function calcGaugesLabelData(gauges, chart) {
  gauges.forEach(function (gaugeItem) {
    ...
    var formatterType = (0, _typeof2["default"])(formatter);
    data = (0, index$4._util2.deepMerge)(value, data).map(function (v, i) {
      var label = v;
  ...
  gauges.forEach(function (gaugeItem) {
    ...
    var detailsPosition = data.map(function (_ref3) {
      ...
      if (position === 'center') {
        ...
        point = index$1$1._util.getCircleRadianPoint.apply(void 0, (0, _toConsumableArray2["default"])(center).concat([radius, startAngle]));
      } else if (position === 'end') {
        point = index$1$1._util.getCircleRadianPoint.apply(void 0, (0, _toConsumableArray2["default"])(center).concat([radius, endAngle]));
      }
...
function getAxisLabelStyle(gaugeItem, i) {
  ...
  return (0, index$4._util2.deepMerge)(_objectSpread({}, labelAlign[i]), style);
}
...
function getGaugeArcStyle(gaugeItem, i) {
  ...
  gradient = gradient.map(function (c) {
    return (0, index$3._color.getRgbaValue)(c);
  });
  return (0, index$4._util2.deepMerge)({
    lineWidth: lineWidth,
    gradient: gradient
...
function getPointerStyle(gaugeItem) {
  ...
  return (0, index$4._util2.deepMerge)({
    rotate: (0, index$4._util2.radianToAngle)(angle),
    scale: [1, 1],
    graphCenter: center
  }, style);
}
...
function getStartPointerConfig(gaugeItem) {
  ...
  config.style.rotate = (0, index$4._util2.radianToAngle)(startAngle + Math.PI / 2);
  return [config];
}
...
styleInject_es.unwrapExports(gauge_1$1);
var gauge_2 = gauge_1$1.gauge;

var legend_1$1 = styleInject_es.createCommonjsModule(function (module, exports) {
...
function legend(chart) {
  ...
  if (legend) {
    legend = (0, index$4._util2.deepMerge)((0, index$1$1._util.deepClone)(config.legendConfig, true), legend);
...
function getBeforeWidth(startIndex, currentIndex, legend) {
  ...
  return (0, index$4._util2.mulAdd)(beforeItem.map(function (_ref2) {
...
function getHorizontalXOffset(data, legend, chart) {
  ...
  var allWidth = (0, index$4._util2.mulAdd)(data.map(function (_ref3) {
...
function getTextStyle(legendItem, i) {
  ...
  return (0, index$4._util2.deepMerge)((0, index$1$1._util.deepClone)(style, true), align);
}
...
styleInject_es.unwrapExports(legend_1$1);
...
var charts_class = styleInject_es.createCommonjsModule(function (module, exports) {
...
var _cRender = index$1$1._interopRequireDefault(index$4.require$$3);
...
Charts.prototype.setOption = function (option) {
  ...
  var optionCloned = (0, index$1$1._util.deepClone)(option, true);
...
styleInject_es.unwrapExports(charts_class);
...
var _charts = index$1$1._interopRequireDefault(charts_class);
...
var Charts = styleInject_es.unwrapExports(lib);

exports.Charts = Charts;
//# sourceMappingURL=index-7a77d038.js.map
